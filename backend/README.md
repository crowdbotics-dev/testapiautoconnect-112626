...
## Project Structure
    ...
    ├── testapiautoconnect_112626  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_112626`
...
2. Clone this repo and `cd testapiautoconnect_112626`
